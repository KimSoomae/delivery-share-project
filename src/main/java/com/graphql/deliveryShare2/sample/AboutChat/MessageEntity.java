...
public class MessageEntity {
    ...
    public MessageEntity(Boolean is_read, OffsetDateTime created_at, OffsetDateTime updated_at, String text, int fromseq, int toseq, UserEntity from,  UserEntity to){
